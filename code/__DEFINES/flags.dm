...
// Bitflags for clan curses, used in clane_curse_flags
#define CURSE_BAALI (1<<0)
#define CURSE_ASSAMITE (1<<1)
#define CURSE_BRUJAH (1<<2)
#define CURSE_CAITIFF (1<<3)
#define CURSE_CAPPADOCIAN (1<<4)
#define CURSE_DOC (1<<5)
#define CURSE_GANGREL (1<<6)
#define CURSE_GARGOYLE (1<<7)
#define CURSE_GIOVANNI (1<<8)
#define CURSE_KIASYD (1<<9)
#define CURSE_LASOMBRA (1<<10)
#define CURSE_MALKAVIAN (1<<11)
#define CURSE_SETITE (1<<12)
#define CURSE_NOSFERATU (1<<13)
#define CURSE_OLD_TZIMISCE (1<<14)
#define CURSE_SALUBRI (1<<15)
#define CURSE_TOREADOR (1<<16)
#define CURSE_TREMERE (1<<17)
#define CURSE_TRUJAH (1<<18)
#define CURSE_TZIMISCE (1<<19)
#define CURSE_VENTRUE (1<<20)
