...
#define ADMIN_AM(user) "(<a href='?_src_=holder;[HrefToken(TRUE)];adjustmasquerade=[REF(user)]'>AM</a>)"
#define ADMIN_AH(user) "(<a href='?_src_=holder;[HrefToken(TRUE)];adjusthumanity=[REF(user)]'>AH</a>)"
