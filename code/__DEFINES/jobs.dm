...
#define DEPARTMENT_BITFLAG_ENDRON			(1<<10)
#define DEPARTMENT_ENDRON					"Endron"
#define DEPARTMENT_BITFLAG_PAINTED_CITY		(1<<11)
#define DEPARTMENT_PAINTED_CITY				"Painted City"
#define DEPARTMENT_BITFLAG_AMBERGLADE		(1<<12)
