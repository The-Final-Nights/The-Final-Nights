...
/obj/item/organ/eyes/night_vision/maintenance_adapted/Insert(mob/living/carbon/eye_owner)
	. = ..()
...
/obj/item/organ/eyes/night_vision/maintenance_adapted/Remove(mob/living/carbon/unadapted, special = FALSE, movement_flags)
