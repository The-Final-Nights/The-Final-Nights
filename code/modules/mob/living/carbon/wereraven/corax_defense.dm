...
/mob/living/carbon/corax/hitby(atom/movable/AM, skipcatch, hitpush, blocked, datum/thrownthing/throwingdatum)
	..(AM, skipcatch = TRUE, hitpush = FALSE)

/mob/living/carbon/corax/attack_hand(mob/living/carbon/human/M)
	. = ..()
...
/mob/living/carbon/corax/attack_animal(mob/living/simple_animal/M)
	. = ..()
	do_rage_from_attack()
	if(.)
...
/mob/living/carbon/corax/ex_act(severity, target, origin)
...
/mob/living/carbon/corax/soundbang_act(intensity = 1, stun_pwr = 20, damage_pwr = 5, deafen_pwr = 15)
	return 0

/mob/living/carbon/corax/acid_act(acidpwr, acid_volume)
...
/mob/living/carbon/corax/crinos/do_attack_animation(atom/A, visual_effect_icon, obj/item/used_item, no_effect)
	if(!no_effect && !visual_effect_icon)
		visual_effect_icon = ATTACK_EFFECT_CLAW
	..()

/mob/living/carbon/corax/lupus/do_attack_animation(atom/A, visual_effect_icon, obj/item/used_item, no_effect)
	if(!no_effect && !visual_effect_icon)
		visual_effect_icon = ATTACK_EFFECT_BITE
	..()

/mob/living/carbon/corax/getarmor(def_zone, type)
	if(type == BRUTE)
		return corax_armor
	else
		return 0
