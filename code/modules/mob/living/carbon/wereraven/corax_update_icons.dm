// a copy of corax_update_icons, for Corax

/mob/living/carbon/corax/update_damage_overlays() //aliens don't have damage overlays.
	return

/mob/living/carbon/corax/update_body() // we don't use the bodyparts or body layers for aliens.
	return

/mob/living/carbon/corax/update_body_parts()//we don't use the bodyparts layer for aliens.
	return

/mob/living/carbon/corax/crinos/update_icons()
	cut_overlays()
...
/mob/living/carbon/corax/crinos/regenerate_icons()
	if(!..())
	//	update_icons() //Handled in update_transform(), leaving this here as a reminder
		update_transform()

/mob/living/carbon/corax/crinos/update_transform() //The old method of updating lying/standing was update_icons(). Aliens still expect that.
	. = ..()
	update_icons()
