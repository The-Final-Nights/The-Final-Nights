...
/obj/necrorune/insight/complete()
	...
	var/mob/dead/observer/victim_ghost = null
	...
	if(victim_ghost)
		permission = tgui_input_list(victim_ghost, "[usr.real_name] wishes to know of your passing. Will you give answers?", "Select", list("Yes","No","I don't recall"), "No", 1 MINUTES)
