/datum/vampireclane/nagaraja
	...
	curse = "Instead of a normal diet, the Nagaraja are only able to subsist off of the flesh and viscera of their prey, earning the nickname of 'Flesh-Eaters' among their bretheren."
