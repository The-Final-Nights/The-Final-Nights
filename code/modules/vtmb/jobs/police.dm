...
/datum/job/vamp/districtattorney
	...
	allowed_species = list("Human")
	duty = "You are a district attorney, a federal lawyer working directly with the PD to process criminals. Help maintain law and order in the city, using the infinate power of buerocracy to make people's lives easier!"
	minimal_masquerade = 0
