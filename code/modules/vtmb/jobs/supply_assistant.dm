...
/datum/job/vamp/supply
	...
	allowed_bloodlines = list("True Brujah", "Daughters of Cacophony", "Brujah", "Baali", "Nosferatu", "Gangrel", "Toreador", "Malkavian", "Banu Haqim", "Tzimisce", "Caitiff", "Lasombra", "Gargoyle", "Kiasyd", "Cappadocian")
