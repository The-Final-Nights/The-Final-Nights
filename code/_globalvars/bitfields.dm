...
DEFINE_BITFIELD(clane_curse_flags, list(
	"CURSE_BAALI" = CURSE_BAALI,
	"CURSE_ASSAMITE" = CURSE_ASSAMITE,
	"CURSE_BRUJAH" = CURSE_BRUJAH,
	"CURSE_CAITIFF" = CURSE_CAITIFF,
	"CURSE_CAPPADOCIAN" = CURSE_CAPPADOCIAN,
	"CURSE_DOC" = CURSE_DOC,
	"CURSE_GANGREL" = CURSE_GANGREL,
	"CURSE_GARGOYLE" = CURSE_GARGOYLE,
	"CURSE_GIOVANNI" = CURSE_GIOVANNI,
	"CURSE_KIASYD" = CURSE_KIASYD,
	"CURSE_LASOMBRA" = CURSE_LASOMBRA,
	"CURSE_MALKAVIAN" = CURSE_MALKAVIAN,
	"CURSE_SETITE" = CURSE_SETITE,
	"CURSE_NOSFERATU" = CURSE_NOSFERATU,
	"CURSE_OLD_TZIMISCE" = CURSE_OLD_TZIMISCE,
	"CURSE_SALUBRI" = CURSE_SALUBRI,
	"CURSE_TOREADOR" = CURSE_TOREADOR,
	"CURSE_TREMERE" = CURSE_TREMERE,
	"CURSE_TRUJAH" = CURSE_TRUJAH,
	"CURSE_TZIMISCE" = CURSE_TZIMISCE,
	"CURSE_VENTRUE" = CURSE_VENTRUE,
))
