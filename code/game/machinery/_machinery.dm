...
/obj/proc/can_be_unfasten_wrench(mob/user, silent) //if we can unwrench this object; returns 90 and FAILED_UNFASTEN, which are both TRUE, or CANT_UNFASTEN, which isn't.
